...
?>
          ...
          <div clas="col-md-2"style="padding-left: 3%;" >
...
if($rows2["email"] == "admin@hotmail.com"):
  ...
  <a id="excluir" class="btn btn-danger" href="../sub-rotinas/excluirProcCorporais.php?id_proc=<?php echo $rows["id_proc"]?>">excluir</a>

  <a id="excluir"  style="margin-right: 5%;" class="btn btn-warning" href="editarProcCorporais.php?id_proc=<?php echo $rows["id_proc"];?>">alterar</a>
